...
require (
	...
	github.com/pulumi/pulumi-dotnet/pulumi-language-dotnet/v3 v3.112.1 // indirect
	github.com/pulumi/pulumi-java v1.36.2 // indirect
	github.com/pulumi/pulumi-yaml v1.38.4 // indirect
